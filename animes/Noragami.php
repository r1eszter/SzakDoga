...
<body>
    ...
    <div class="main">
        ...
        <div class="title" style="color: white;">
            ...
            /* the japanes title */
            echo "<h1 class='jap' style='color: rgb(51, 0, 102);'>". $row["jtitle"] . "</h1>"; 
            } ?>
        </div>
        ...
        <div class="data" style="color: white;">
            <?php while($row = mysqli_fetch_assoc($data_result)) {
                echo "<p class='prog' style='color: rgb(51, 0, 102);'>Synopsis</p>";
                echo $row["synopsis"];

                echo "<p class='prog' style='text-align: center; font-size: 140%; color: rgb(51, 0, 102);'> <br> ". $row["episodes"] . " episodes </p>";
                
                echo "<p class='prog' style='color: rgb(51, 0, 102);'> <br> Genres </p>";
                echo $row["genres"];
                
                echo "<p class='prog' style='color: rgb(51, 0, 102);'> <br> Studio </p>";
                echo $row["studio"];

                echo "<p class='prog' style='color: rgb(51, 0, 102);'> <br> Aired </p>";
